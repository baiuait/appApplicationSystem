                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <!-- form -->
                                <form class="form-horizontal form-label-left" novalidate method="post" id="addForm" action="version/versionAdd" enctype="multipart/form-data">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="versionNo" class="form-control col-md-7 col-xs-12"
                                                   name="versionNo" required="required" type="text">
                                        </div>
                                    </div>
                                    <!-- 版本大小 -->
                                    <div class="item form-group">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" value="预发布" readonly/>
                                            <input type="hidden" value="9" id="publishStatus" name="publishStatus">
                                        </div>
                                    </div>
                                    <!-- 版本简介 -->
                                    <div class="item form-group">
                                    ...
                                    <!-- apk文件 -->
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="up_apkLocPath">apk文件
                                            <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="file" class="form-control col-md-7 col-xs-12"
                                                   id="up_apkLocPath" name="up_apkLocPath"/>
                                        </div>
