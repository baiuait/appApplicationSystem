    ...
    <div class="left_col scroll-view">
        ...
        <div class="profile">
            ...
            <div class="profile_info">
                <span>Welcome,</span>
                <h2>${sessionScope.session_backend_user.userName}</h2>
            </div>
        </div>
        <!-- /menu profile quick info -->
                ...
                <ul class="nav side-menu">
                    <li><a><i class="fa fa-edit"></i> APP 应用管理 <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="backendUser/toAppMaintain"> APP审核 </a></li>
                        </ul>
                    </li>
                </ul>
            </div>
        ...
        <div class="sidebar-footer hidden-small">
            ...
            <a data-toggle="tooltip" data-placement="top" title="Logout" href="backendUser/logout">
